    ...
    const baseContent = (
      <>
        ...
        <p>
          ...
          <strong>einen echten Gewinn</strong> erzielt hat (<strong>Net Income &gt; 0</strong>, bereinigt um
          Einmaleffekte).
        </p>
        <p>
        ...
        <div className="space-y-2">
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>
              <strong>Robustheit:</strong> Zeigt, ob das Geschäftsmodell <strong>durch Zyklen</strong>{" "}
              (Krisen/Boomphasen) trägt.
            </li>
            <li>
              <strong>Qualität:</strong> Dauerhaft profitabel = oft <strong>Moat</strong>, solide Kundenbindung, gute
              Kostenkontrolle.
            </li>
            <li>
              <strong>Risikobild:</strong> Viele Verlustjahre deuten auf <strong>zyklische/fragile</strong> Strukturen
              oder Fehlsteuerung hin.
            </li>
          </ul>
        </div>
      </>
    ...
    return (
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>
              <strong className="text-success">Grün (stark):</strong> ≥ 9/10 Jahre Gewinn (Top), ideal 10/10.
            </li>
            <li>
              <strong className="text-warning">Gelb (ok):</strong> 8/10 Jahre Gewinn.
            </li>
            <li>
              <strong className="text-danger">Rot (schwach):</strong> ≤ 7/10 Jahre Gewinn oder wiederkehrend große
              Verlustjahre.
            </li>
          </ul>
        </div>
      ...
      return (
        <div className="space-y-2">
          ...
          <ul className="space-y-1 text-sm">
            <li>
              • <strong>10/10</strong> → 4 Punkte
            </li>
            <li>
              • <strong>9/10</strong> → 3 Punkte
            </li>
            <li>
              • <strong>8/10</strong> → 2 Punkte
            </li>
            <li>
              • <strong>7/10</strong> → 1 Punkt
            </li>
            <li>
              • <strong>≤ 6/10</strong> → 0 Punkte
            </li>
          </ul>
        </div>
      );
    ...
    if (preset === "Software") {
      return (
        <div className="space-y-2">
          ...
          <ul className="space-y-1 text-sm">
            <li>
              • <strong>10/10</strong> → 3 Punkte
            </li>
            <li>
              • <strong>9/10</strong> → 2 Punkte
            </li>
            <li>
              • <strong>8/10</strong> → 1 Punkt
            </li>
            <li>
              • <strong>≤ 7/10</strong> → 0 Punkte
            </li>
          </ul>
        </div>
      );
        ...
        <div className="mt-4">
          ...
          <ResponsiveContainer width="100%" height={140}>
            <BarChart data={chartData}>
              ...
              <YAxis tick={{ fontSize: 10 }} stroke="#9ca3af" tickFormatter={(value) => formatValue(value)} />
              <RechartsTooltip
              ...
              <Bar dataKey="value" radius={[4, 4, 0, 0]}>
                {chartData.map((entry, index) => (
                  <Cell key={`cell-${index}`} fill={entry.isProfitable ? "#16a34a" : "#dc2626"} />
                ))}
              </Bar>
            </BarChart>
          </ResponsiveContainer>
          <div className="flex justify-center gap-4 mt-2 text-xs text-muted-foreground">
            <span>
              <span className="text-green-600">■</span> Gewinn
            </span>
            <span>
              <span className="text-red-600">■</span> Verlust
            </span>
          </div>
        </div>
      )}
