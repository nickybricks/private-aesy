    ...
    <div className="max-w-sm space-y-2">
      ...
      <div className="space-y-1">
        ...
        <ul className="text-sm space-y-1 list-disc list-inside">
          <li><strong>Zahlungsfähigkeit:</strong> Reicht das, was in den nächsten Monaten zu Geld wird, um Rechnungen zu zahlen?</li>
          <li><strong>Puffer:</strong> Höhere Ratio = mehr <strong>Sicherheit</strong> bei Gegenwind.</li>
          <li><strong>Arbeitskapital-Qualität:</strong> Zeigt, wie gesund Forderungen & Vorräte sind.</li>
        </ul>
      </div>
    </div>
  );
      ...
      {chartData.length > 1 && (
        <div className="mt-4">
          ...
          <div className="flex justify-center gap-4 mt-2 text-xs text-muted-foreground">
            <span><span className="text-green-600">---</span> 2.0 (Stark)</span>
            <span><span className="text-red-600">---</span> 1.2 (Risikogrenze)</span>
          </div>
        </div>
      )}
    </Card>
