...
export const NetMarginCard: React.FC<NetMarginCardProps> = ({
  ...
  const getScoringTooltip = () => {
    if (preset === "Industrials") {
      return (
        <div className="space-y-1">
          ...
          <p className="text-sm">
            <span className="text-yellow-600">●</span> 1 Pkt: 7–&lt;10%
          </p>
          <p className="text-sm">
            <span className="text-red-600">●</span> 0 Pkt: &lt; 7%
          </p>
        </div>
      );
    }
    ...
    if (preset === "Software") {
      return (
        <div className="space-y-1">
          ...
          <p className="text-sm">
            <span className="text-green-600">●</span> 3 Pkt: ≥ 18%
          </p>
          <p className="text-sm">
            <span className="text-green-500">●</span> 2 Pkt: 14–&lt;18%
          </p>
          <p className="text-sm">
            <span className="text-yellow-600">●</span> 1 Pkt: 10–&lt;14%
          </p>
          <p className="text-sm">
    ...
    return (
      <div className="space-y-1">
        ...
        <p className="text-sm">
          <span className="text-green-600">●</span> 3 Pkt: ≥ 15%
        </p>
        <p className="text-sm">
  ...
  const tooltipContent = (
    <div className="max-w-sm space-y-2">
      ...
      <p className="text-sm">
        Sie sagt, wie viel <strong>vom Umsatz nach allen Kosten und Steuern</strong> als <strong>Gewinn</strong> übrig
        bleibt.
      </p>
      <p className="text-sm">
