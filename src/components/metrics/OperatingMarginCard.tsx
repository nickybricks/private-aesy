...
export const OperatingMarginCard: React.FC<OperatingMarginCardProps> = ({ 
  ...
  const getBgColor = (score: number, maxScore: number): string => {
    ...
    if (ratio >= 0.50) return 'bg-yellow-50 border-yellow-200';
    ...
    if (preset === 'Industrials') {
      return (
        <div className="space-y-1">
          ...
          <p className="text-sm"><span className="text-green-600">●</span> 4 Pkt: ≥ 16%</p>
          <p className="text-sm"><span className="text-green-500">●</span> 3 Pkt: 12–&lt;16%</p>
          <p className="text-sm"><span className="text-yellow-600">●</span> 2 Pkt: 9–&lt;12%</p>
          <p className="text-sm"><span className="text-orange-600">●</span> 1 Pkt: 6–&lt;9%</p>
          <p className="text-sm"><span className="text-red-600">●</span> 0 Pkt: &lt; 6%</p>
        </div>
      );
    }
    ...
    <div className="max-w-sm space-y-2">
      ...
      <div className="space-y-1">
        ...
        <ul className="text-sm space-y-1 list-disc list-inside">
          <li><strong>Kerngeschäfts-Stärke:</strong> Misst die wahre Ertragskraft.</li>
          <li><strong>Preissetzung & Kostenkontrolle:</strong> Hohe Marge = Preise durchsetzbar.</li>
          <li><strong>Puffer in Krisen:</strong> Dickere Marge = mehr Schutz.</li>
        </ul>
      </div>
