    ...
    <main className="flex-1 overflow-auto bg-background">
      <div className="h-full">
        <div className="p-3 sm:p-4 md:p-6 w-full">
          ...
          <div className="mb-6">
            <h1 className="text-3xl font-bold mb-2">Peter Lynch Chart</h1>
            <p className="text-muted-foreground">
              Visualisierung der Aktienbewertung nach Peter Lynch's Prinzipien
            </p>
          </div>
