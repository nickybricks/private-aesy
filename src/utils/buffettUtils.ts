...
export const calculateFinancialMetricScore = (
  ...
  const epsWeight = 10 - roeWeight - marginWeight; // ergibt exakt 10
  ...
  if (metrics.roe !== undefined && metrics.roe !== null) {
    if (metrics.roe >= 15) {
      ...
      console.log(`ROE ${metrics.roe}% >= 15%: +${roeWeight.toFixed(2)} → totalScore: ${totalScore.toFixed(2)}`);
    } else if (metrics.roe >= 10) {
      totalScore += roeWeight * 0.6;
      console.log(`ROE ${metrics.roe}% >= 10%: +${(roeWeight * 0.6).toFixed(2)} → totalScore: ${totalScore.toFixed(2)}`);
    } else if (metrics.roe >= 5) {
      totalScore += roeWeight * 0.3;
      console.log(`ROE ${metrics.roe}% >= 5%: +${(roeWeight * 0.3).toFixed(2)} → totalScore: ${totalScore.toFixed(2)}`);
    } else {
      console.log(`ROE ${metrics.roe}% < 5%: +0 → totalScore: ${totalScore.toFixed(2)}`);
    }
  }
  ...
  if (metrics.netProfitMargin !== undefined && metrics.netProfitMargin !== null) {
    if (metrics.netProfitMargin >= 15) {
      ...
      console.log(`Nettomarge ${metrics.netProfitMargin}% >= 15%: +${marginWeight.toFixed(2)} → totalScore: ${totalScore.toFixed(2)}`);
    } else if (metrics.netProfitMargin >= 10) {
      totalScore += marginWeight * 0.6;
      console.log(`Nettomarge ${metrics.netProfitMargin}% >= 10%: +${(marginWeight * 0.6).toFixed(2)} → totalScore: ${totalScore.toFixed(2)}`);
    } else if (metrics.netProfitMargin >= 5) {
      totalScore += marginWeight * 0.3;
      console.log(`Nettomarge ${metrics.netProfitMargin}% >= 5%: +${(marginWeight * 0.3).toFixed(2)} → totalScore: ${totalScore.toFixed(2)}`);
    } else {
      console.log(`Nettomarge ${metrics.netProfitMargin}% < 5%: +0 → totalScore: ${totalScore.toFixed(2)}`);
    }
  }

  // EPS-Wachstum Bewertung
  if (metrics.epsGrowth !== undefined && metrics.epsGrowth !== null) {
    if (metrics.epsGrowth >= 10) {
      totalScore += epsWeight;
      console.log(`EPS-Wachstum ${metrics.epsGrowth}% >= 10%: +${epsWeight.toFixed(2)} → totalScore: ${totalScore.toFixed(2)}`);
    } else if (metrics.epsGrowth >= 5) {
      totalScore += epsWeight * 0.6;
      console.log(`EPS-Wachstum ${metrics.epsGrowth}% >= 5%: +${(epsWeight * 0.6).toFixed(2)} → totalScore: ${totalScore.toFixed(2)}`);
    } else if (metrics.epsGrowth >= 0) {
      totalScore += epsWeight * 0.3;
      console.log(`EPS-Wachstum ${metrics.epsGrowth}% >= 0%: +${(epsWeight * 0.3).toFixed(2)} → totalScore: ${totalScore.toFixed(2)}`);
    } else {
      console.log(`EPS-Wachstum ${metrics.epsGrowth}% < 0%: +0 → totalScore: ${totalScore.toFixed(2)}`);
    }
  }
