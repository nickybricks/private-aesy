...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Starting USD-based historical exchange rate fetch from 1980...')
    ...
    console.log(`\n✅ USD historical fetch complete: ${totalUpdates} rates updated`)
    if (errors.length > 0) {
    ...
    console.error('Fatal error fetching USD historical exchange rates:', error)
    return new Response(
